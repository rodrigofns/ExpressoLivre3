...
p.i18n = {
  ...
  filename_col_title: 'Nome do Arquivo',
  filename_col_width: 230,  
  note_col_title: 'Status',
  note_col_width: 150,
  add_btn_text: 'Adicionar',
  add_btn_tip: 'Adicionar imagem.',
  remove_btn_text: 'Remover',
  remove_btn_tip: 'Remover arquivo da fila.',
  reset_btn_text: 'Limpar',
  reset_btn_tip: 'Limpar.',
  upload_btn_start_text: 'Upload',
  upload_btn_stop_text: 'Cancelar',
  upload_btn_start_tip: 'Upload.',
  upload_btn_stop_tip: 'Cancelar upload.',
  close_btn_text: 'Fechar',
  close_btn_tip: 'Fechar',
  progress_waiting_text: 'Conclu&iacute;do',
  progress_uploading_text: 'Imagens: {0} de {1} imagens.',
  error_msgbox_title: 'Erro',
  permitted_extensions_join_str: ',',
  err_file_type_not_permitted: 'Tipo de arquivo não permitido.<br/>Por favor, selecione os arquivos com as seguintes extens&otilde;es: {1}',
  note_queued_to_upload: 'Pendente.',
  note_processing: 'Carregando...',
  note_upload_failed: 'Erro interno no servidor ou serviço indispon&iacute;vel.',
  note_upload_success: 'Conclu&iacute;do.',
  note_upload_error: 'Erro no Upload.',
  note_aborted: 'Cancelado pelo usu&aacute;rio.'
}
