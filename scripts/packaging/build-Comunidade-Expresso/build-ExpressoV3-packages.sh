...
function checkout()
{
    ...
    #git checkout $2
    #git clone ssh://root@10.31.80.37/usr/local/git.repos/expresso3.git
    git clone $1
    ...
    mv $TEMPDIR/tine20.git/expresso3/tine20 $TEMPDIR/tine20
    mv $TEMPDIR/tine20.git/expresso3/scripts/packaging/debian $TEMPDIR/debian
    rm -Rf $TEMPDIR/tine20.git
        ...
        if [ -d "$TEMPDIR/tine20/$FILE/translations" ]; then
            case $FILE in
                ...
                Tinebase)
                    ...
                    echo -n "building "
                    local FILES="Addressbook Admin Setup Tinebase Zend images library styles themes config.inc.php.dist index.php langHelper.php LICENSE PRIVACY README RELEASENOTES setup.php tine20.php"
